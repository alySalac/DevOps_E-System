...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    $target_dir1 = "images/img/";
    $target_file1 = $target_dir1 . basename($_FILES["fileToUpload"]["name"]);
    $title = "";
    $caption = "";

    $send = "INSERT INTO tb_cards (path, newpath, title, caption) VALUES ('$target_file', '$target_file1','$title', '$caption')";
    ...
    <strong>Upload Successfull ! </strong> No errors occured</a>.
  </div>';
    ...
    $_SESSION['upload'] = '<div class="alert alert-danger">
    <strong>Upload failed! </strong> Error Occured</a>.
  </div>';
  header('Location: ../dashboardcontent/dashboard.php');
  }
}
